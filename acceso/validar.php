     ...
     <td><input type="hidden" name="clave" value="<?echo $clave;?>" </td>
      <table border="0" align="center">
         ...
         <tr>
           ...
           <td><input type="password" name="actual" value="" size="20" maxlength="20" onFocus="ColorFoco(this.id)" onBlur="QuitarFoco(this.id)" id="actual">&nbsp;</td>
         </tr>
         <tr>
           <td><b>Nueva Clave:</b></td>
           <td><input type="password" name="nueva" value="" size="20" maxlength="20"onfocus="ColorFoco(this.id)" onBlur="QuitarFoco(this.id)" id="nueva">&nbsp;</td>         </tr>
         <tr>
