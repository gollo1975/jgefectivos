...
?>
     ...
     <?
         ...
         $nueva=strtoupper($nueva);
          ...
          if ($reg!=0):
             $consulta="update accesoasociado set clave='$nueva' where usuario='$usuario'";
             ...
             echo "<script language=\"javascript\">";
                   ...
                   // echo "open (\"../menuasociado.php?op=curso\",\"contenido\");";
                     echo ("open (\"cambiardatoasociado.php\",\"_self\");");
                echo "</script>";
          else:
          ?>
             <script language="javascript">
