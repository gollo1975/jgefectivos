...
<?
  ...
  ?>
  <center><h4>Consulta de Contratista</h4></center>
      ...
      $consu="select zona.codzona,zona.zona from zona
                where zona.codzona='$campo'";
                 ...
                 $filas=mysql_fetch_array($resulta)
                   ...
                   <?
                   $con="select empleado.cedemple,concat(nomemple,' ',nomemple1,' ',apemple,' ',apemple1) as nombre,contrato.fechainic,contrato.salario from empleado,zona,contrato
                    ...
                    if($reg!=0):
                      ?>
                      <center><h4>Listado de Contratistas</h4></center>
                      <table border="0" align="center">
                      <tr class="cajas"><td>Para ver el Listado de Empleados por contratista, presione Click sobre la[CEDULA]...</td></tr>
                      </table>
                      <table border="1" align="center">
                        ...
                        ?>
                          <tr class="cajas">
                             <td><a href="detalladobusqueda.php?cedula=<? echo $filas_s["cedemple"];?>&codzona=<? echo $campo;?>"><? echo $filas_s["cedemple"];?></a></td>
