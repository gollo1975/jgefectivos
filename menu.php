  ...
  <?php
      ...
      ?>
        ...
        <br>
            ...
            <div class="itemmenu">
                ...
                <a href="menu.php?op=carpeta" target="contenido">Entrega de Carpetas</a><Br>				
                <a href="menu.php?op=eps" target="contenido">EPS</a><Br>
				<a href="menu.php?op=CajaC" target="contenido">Caja de Compensación</a><Br>
				...
				<a href="menu.php?op=procesar&codigo=<?echo $xsession;?>" target="contenido">Procesar</a><Br>
		...
		<a href="solicitudSS/procesos.php?opc=3" target="contenido">Solicitudes Pendientes</a><Br>			
            ...
            <div class="itemmenu">
                ...
                <a href="menu.php?op=contrato&UsuarioPreparador=<?echo $xsession; ?>" target="contenido">Contrato</a><br>				
                <a href="menu.php?op=empleado&op1=admemp&UsuarioPreparador=<?echo $xsession; ?>" target="contenido">Empleado</a><br>
                <a href="menu.php?op=generar" target="contenido">Generar</a><br>				
                <a href="menu.php?op=sala" target="contenido">Item Salario</a><br>
                <a href="menu.php?op=curso" target="contenido">Trabajo en Altura</a><br>
            </div>
            <?
            }
            ?>
            ...
            <div class="itemmenu">
                ...
                <a href="menu.php?op=memorando&op1=admemp&admon=<?echo $xsession;?>" target="contenido">Memorando</a><br>  
                ...
                <a href="menu.php?op=CesaInte" target="contenido">Cesantias e Interes</a><br>
            </div>
            <?
            }
            ?>
            ...
            <div class="itemmenu">
                ...
                <a href="menu.php?op=examen&CodUsuario=<?echo $xsession;?>" target="contenido">Examenes de Ingreso</a><br>
                <a href="menu.php?op=examenadmon" target="contenido">Administrar Examenes</a><br>
            ...
            {
            $xsession=strtoupper($xsession);
            ?>
            <div class="itemmenu">
                <a href="menu.php?op=carne" target="contenido">Carnet de Empleado</a><br>
                <a href="menu.php?op=carpetas" target="contenido">Carpetas Empleados</a><br>				
				...
				<a href="empresas/consultarEmpleadoGeneral.php" target="contenido">Documentación Empleados General</a><br>				
                ...
                <a href="menu.php?op=utilidadservicio" target="contenido">Utilidad de Servicio</a><br>  
                <a href="menu.php?op=convendedor" target="contenido">Vendedores</a><br>								
                <a href="menu.php?op=listarzo&Usuario=<?echo $xsession;?>" target="contenido">Zona</a><br>
				...
				<a href="documental/consultaProduccion.php" target="contenido">Producción Gestion Documental</a><br>
				<a href="control/vista/consultaVisitas.php" target="contenido">Consulta de Visitantes</a><br>
				<a href="control/control/fachada.php?opc=71&valor='08'" target="contenido">Consulta Visitantes en Espera</a><br>
            </div>
            <?
            }
            ?>
           ...
           <div class="lbmenu">
            ...
            if ($tipoMenu=="CONTABILIDAD")
            {
             ...
             <div class="itemmenu">
                ...
                <a href="menu.php?op=comprobantes&op1admemp" target="contenido">Tipo Comprobante</a><br>
                <a href="menu.php?op=comproegreso&Usuario=<?echo $xsession;?>" target="contenido">Comprobante de Egreso</a><br> 
           ...
           ?>
           <div class="lbmenu">
                <a href="menu.php?tipoM=SALIR"><font size=3>+</font></a>CERRAR SESION
            </div>
            <?
            if ($tipoMenu=="SALIR")
            {
    ...
    /*menu retiro*/
     ...
     if ($opcion=="novedad")
      ...
      if ($opcion=="CesaInte")
        include ("vacaciones/MenuCesaInter.php");
     /*menu costo*/
     if ($opcion=="funeraria")
     ...
     if ($opcion=="prove")
      ...
      if ($opcion=="utilidadservicio")
         include ("factura/menutilidad.php");
        /*menu reportes*/
       if ($opcion=="asocia")
