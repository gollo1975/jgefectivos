...
var popUpCal = {
  ...
  drawCalendar: function(inputObj) {
    ...
    var html = '';
    html = '<a id="closeCalender">Cerrar Ventana</a>';
...
function getMonthName(month) {
  var monthNames = new Array('Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Augosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre');
