<html>
        ...
        <?
                ...
                if (empty($valor))
                {
                        ...
                        where sucursal.codsucursal=zona.codsucursal order by zona.zona";
                }
                elseif ($campo=='codigo')
                {
        ...
        <?
                ...
                {
        ?>
                           <td><div align="center"><a href="listadomodificar.php"><u><h4><font color="blue">Actualizar</font></h4></u></a></div></td>
                           <table border="1" align="center">
                                <tr><td></td></tr></tr>
                                <tr>
                                        <th>Item</th>
        ...
        ?>
                                <tr class="cajas">
                                        <th><?echo $a;?></th>
                                         <td>&nbsp;<a href="modificacion.php?cod=<?echo $filas["codzona"];?>"><?echo $filas["codzona"];?></a></td>
