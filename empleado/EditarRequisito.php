...
$UsuarioPreparador= strtoupper($UsuarioPreparador);
   include("../conexion.php");
	   ?>
	  <div align="center"><h4><u>Editar Check de Lista</u></h4></div>
	     ...
	     <div align="center"><h4><u>Editar Check de Lista</u></h4></div>
              ...
              <table border="0" align="center">
                  ...
                  while($fila=mysql_fetch_array($res)){
                       ...
                       <tr class="cajas">
	                       <th><?echo $a;?></th>
	                       <td><a href="DetalladoEditado.php?NroId=<?echo $fila["idRequisito"];?>&Tipo=<?echo $fila["tiporequisito"];?>&Nota=<?echo $fila["nota"];?>&Documento=<?echo $Cedula;?>&Nombre=<?echo $fila["nombre"];?>&UsuarioPreparador=<?echo $UsuarioPreparador;?>"><?echo $fila["idRequisito"];?></a></td>
	                       <td><?echo $Cedula;?></td>
