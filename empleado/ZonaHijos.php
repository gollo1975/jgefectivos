...
if($Zona==0):
 ?>
	    <script language="javascript">
	      alert("Seleccione la Zona para la busqueda")
	      history.back()
	    </script>
	   <?
else:
	include("../conexion.php");
	$ConH="select detallempleado.*,zona.zona from zona,empleado,detallempleado,contrato
	where zona.codzona=empleado.codzona and
	empleado.cedemple=detallempleado.cedemple and
	empleado.codemple=contrato.codemple and
	contrato.fechater='0000-00-00' and
	zona.codzona='$Zona'order by detallempleado.empleado";
