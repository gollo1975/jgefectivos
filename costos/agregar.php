            ...
            <center><h4><u>Centro de Costo</u></h4></center>
             <form action="" method="post" id="matcentro">
                        <table border="0" align="center"
                                ...
                                <tr>
                                        <td><b>Codigo:</b> </td>
                                        <td><input type="text" name="codcosto" value="" size="13" class="cajas" mexlength="10"onfocus="ColorFoco(this.id)" onblur="QuitarFoco(this.id)" id="codcosto">
                                </tr>
                                <tr>
                                        <td><b>Descripción:</b></td>
                                        <td><input type="text" name="centro" value="" size="40" class="cajas" mexlength="60"onfocus="ColorFoco(this.id)" onblur="QuitarFoco(this.id)" id="centro">
                                </tr>
                                <tr><td><br></td></tr>
                  <tr>
                   ...
                   <?
                        ...
                        else
                        {
								...
								$codcosto=strtoupper($codcosto);
                                $consulta="select * from costo where codcosto='$codcosto'";
                                $resultado=mysql_query($consulta) or die("consulta incorrecta");
                                $registros=mysql_num_rows($resultado);
                                if ($registros==0)
                                {
                                        $consulta="insert into costo (codcosto,centro)
