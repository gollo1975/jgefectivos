  ...
  <title>Comprobantes Contables</title>
   ...
   <script language="javascript">
                      ...
                      function chequearcampos()
                    {
                        ...
                        {
                            alert ("Digite la descripción del tipo de Comprobante.?");
...
<?if(!isset($descripcion)):
  ?>
  <div align="center"><h4><u>Tipo de Comprobante</u></h4></div>
  <form action="" method="post" id="matcom">
    <table border="0" align="center">
      ...
      <tr>
         ...
         <td><input type="text" name="PorC" class="cajas" size="5" maxlength="5" onfocus="ColorFoco(this.id)" onblur="QuitarFoco(this.id)" id="PorC">&nbsp;</td>
      </tr>
      <tr><td><br></td></tr>
      <tr>
        <td colspan="3">
  ...
  include("../conexion.php");
    ...
    $ingreso="insert into tipocomprobante(descripcion,cuenta,porcentaje)
       values('$descripcion','$CtaC','$PorC')";
    ...
    $re = mysql_affected_rows();
     if($re != 0 ):
       ...
       <script language="javascript">
         ...
         open("comprobantecontable.php","_self")
       </script>
       <?
     else:
       ?>
