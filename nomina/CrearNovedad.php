...
?>
<tr class="cajas">
  <td><a href="DetalladoNovedad.php?codigo=<?echo $filas["codsucursal"];?>&Auxiliar=<?echo $Auxiliar;?>&Documento=<?echo $Documento;?>"><div align="center"><?echo $filas["codsucursal"];?></div></a></td>
