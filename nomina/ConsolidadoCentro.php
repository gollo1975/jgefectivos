      ...
      $consulta="select maestro.codmaestro,maestro.dvmaestro,maestro.nomaestro,sucursal.sucursal,maestro.dirmaestro,maestro.telmaestro,maestro.faxmaestro,zona.zona,nomina.*,empleado.nomemple,empleado.nomemple1,empleado.apemple,empleado.apemple1,empleado.cuenta,observacion.descripcion,eps.eps,pension.pension from maestro,nomina,empleado,eps,pension,sucursal,zona,periodo,costo,observacion
                where maestro.codmaestro=sucursal.codmaestro and
                 ...
                 zona.codzona='$CodZona' order by empleado.nomemple,empleado.apemple";
                   $resultado=mysql_query($consulta) or die("Errro al buscar Nomina ");
