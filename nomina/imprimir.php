<html>
        ...
        <body onLoad="imprimir()">  <!-- sirve para cargar la funcion de imprsion-->
               <?
						...
						$consulta = "select maestro.codmaestro,maestro.dvmaestro,maestro.nomaestro,sucursal.sucursal,maestro.dirmaestro,maestro.telmaestro,
      maestro.faxmaestro,zona.zona,nomina.*,empleado.nomemple,empleado.nomemple1,empleado.apemple,empleado.apemple1,
      empleado.cuenta,observacion.descripcion,eps.eps,pension.pension, contrato.cargo
      from maestro,nomina,empleado,eps,pension,sucursal,zona,observacion, contrato
                             where maestro.codmaestro=sucursal.codmaestro and
                                   ...
                                   (contrato.fechater = '0000-00-00' or contrato.contrato = (select max(contrato.contrato) from contrato inner join empleado on contrato.codemple = empleado.codemple inner join nomina on nomina.cedemple = empleado.cedemple where nomina.consecutivo='$codigo'))";
						
						/*$consulta="select distinct  maestro.codmaestro,maestro.dvmaestro,maestro.nomaestro,sucursal.sucursal,maestro.dirmaestro,maestro.telmaestro,
      maestro.faxmaestro,zona.zona,nomina.*,empleado.nomemple,empleado.nomemple1,empleado.apemple,empleado.apemple1,
      empleado.cuenta,observacion.descripcion,eps.eps,pension.pension, contrato.cargo
      from maestro,nomina,empleado,eps,pension,sucursal,zona,observacion, contrato
                             where maestro.codmaestro=sucursal.codmaestro and
				   ...
				   contrato.fechater = '0000-00-00'";*/
                              ...
                              <tr>
                               ...
                               <tr>
                                ...
                                <tr class="cajasletras">
                                 ...
                                 <tr class="cajasletras">
                                 <td colspan="12" ><b>Documento:</b>&nbsp;<?echo $filas["cedemple"];?></td>
								 <td colspan="18" ><b>Empleado:</b>&nbsp;<?echo $filas["nomemple"];?>&nbsp;<?echo $filas["nomemple1"];?>&nbsp;<?echo $filas["apemple"];?>&nbsp;<?echo $filas["apemple1"];?></td><td colspan="10" ><b>Cuenta:</b>&nbsp;<?echo $filas["cuenta"];?></td>
                                 </tr>
                                 <tr class="cajasletras">
								 ...
								 <td colspan="8" ><b>Hasta:</b>&nbsp;<?echo $filas["hasta"];?></td>
                                 </tr>
                                 <tr class="cajasletras">
                                 <td colspan="12" ><b>Fecha_Proceso:</b>&nbsp;Medellín&nbsp;<?echo $filas["fechap"];?></td>
								 <td colspan="10" ><b>Fecha_Imp:</b>&nbsp;<?echo date("Y-m-d");?></td>
								 <td colspan="8"><b>Eps:</b>&nbsp;<?echo $filas["eps"];?></td>
								 <td colspan="8"><b>Pensión:</b>&nbsp;<?echo $filas["pension"];?></td>
                                 </tr>
                                      <?
                        ...
                        $consu="select denomina.* from salario,denomina,nomina
                             where salario.codsala=denomina.codsala and
                                   ...
                                   nomina.consecutivo='$codigo' order by denomina.salario";
