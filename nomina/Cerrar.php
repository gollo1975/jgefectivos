...
$Documento=$filas_s["cedula"];
        $consulta="select zona.zona,zona.codzona from zona,procesonomina,acceso where
                 zona.codzona=procesonomina.codzona and
           ...
           <?
             ...
             ?>
                ...
                <tr class="cajas">
                   ...
                   ?>
                     <tr class="cajas">
                        <td><a href="CerrarProceso.php?codzona=<?echo $filas["codzona"];?>&Auxiliar=<?echo $Auxiliar;?>&Documento=<?echo $Documento;?>"><?echo $filas["codzona"];?></td>
