...
?>
 ...
 <?
  ...
  ?>
  <center><h4>Sucursales de la Empresa</h4></center>
<table border="0" align="center">
  <tr class="cajas">
    <td>Presione Click,en el Cod_Sucursal para Generar el Periodo.</td>
  </tr>
</table>
...
<tr>
   <th><?echo $a;?></th>
  <td><a href="deperiodo.php?CodSucursal=<?echo $filas["codsucursal"];?>"><div align="center"><?echo $filas["codsucursal"];?></div></td>
