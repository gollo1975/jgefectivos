...
if (!isset($codigo)):
  ?>
    <center><h5>Cambio de Salario y Ayuda de Transporte[Individual]</h5></center>
  ...
  if($reg==0):
    ...
    $reg=mysql_num_rows($re);
            ...
            while($filas=mysql_fetch_array($re)):
               ?>
               <center><h4>Cambio de Salario y Ayuda de Transporte</h4></center>
               <form action="grabarenvio.php" method="post" id="matgene">
