...
?>
<center><h4>Notas Creditos por Zona</h4></center>
       ...
       <tr>
         <td><b>Sucursal:</b></td>
                              ...
                              <option value="0">Seleccione la Zona
                                <?
                                 $consulta_z="select zona.codzona,zona.zona  from zona order by zona.zona";
        ...
        if ($registro==0):
         ...
         ?>
           ...
           <?
             ...
             include("../conexion.php");
            $variable1="select notacredito.nronota,notacredito.nrofactura,notacredito.nit,notacredito.valor,notacredito.fecha from zona,factura,notacredito where
                   ...
                   notacredito.fecha between '$desde'and'$hasta' and
                    zona.codzona='$campo' order by notacredito.fecha ";
