...
<head>
<title>Programacion x Deducción</title>
...
?>
<center><h4><u>Programacion x Deducción</u></h4></center>
  ...
  <?
   ...
   ?>
       ...
       <?
          ...
          include("../conexion.php"); 
          $consulta="select programardeduccion.*,salario.desala from maestro,programardeduccion,salario
              where maestro.codmaestro=programardeduccion.codmaestro and
			        programardeduccion.codsala=salario.codsala and
                    programardeduccion.fechapro between '$Desde' and '$Hasta' and
                   maestro.codmaestro='$campo' order by programardeduccion.fechapro DESC";
               ...
               <tr>
                ...
                <table border="0" align="center">
                  ...
                  while($filas=mysql_fetch_array($resultado)):
                    ...
                    <tr  class="cajas">
                        <th><?echo $suma;?></th>
                         <td><a href="ReporteDeduccion.php?NroReporte=<?echo $filas["id_p"];?>"><div align="center"><?echo $filas["id_p"];?></div></a></td>
						  <td><?echo $filas["desala"];?></td>
                          <td><div align="center"><?echo $filas["fechapro"];?></div></td>
