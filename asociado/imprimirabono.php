<html>
        <head>
                <title>Impresión de abonos a creditos</title>
            ...
            while ($filas=mysql_fetch_array($resultado)):
             ?>
               <table border="0" align="center" width="700">
                 ...
                 <tr>
                  <td colspan="2"><td class="cajas"><b><u>ABONO A PRESTAMO</u></b></td>
                </tr>
                 <td>&nbsp;</td>
                <td>&nbsp;</td>
                <tr>
                 ...
                 <tr>
                  <td colspan="1"</td><td class="cajas"><b>Nro_Crédito:</b>&nbsp;<?echo $filas["nrocredito"];?></td></center>
                </tr>
               </table>
                 <td>&nbsp;</td>
                 <tr>
