<html>
        <head>
                <title>Consulta de Manejo</title>
        </head>
        <body>
        <?
                if (!isset($campo))
        ...
        ?>
                        <form action="" method="post">
                                <table border="1" align="center">
                                        <tr>
                                                <th colspan="8">Consulta Manejo</th>
                                        </tr>
                                        <tr>
        ...
        <?
                ...
                else
                {
                        ...
                        if ($campo=='codmanejo')
                        {
                                $consulta="select * from manejo where $campo='$valor'";
                         }
                        else
                        {
                                $consulta="select * from manejo where  $campo like '%$valor%'";
                        }
        ...
        ?>
                                <table border="1" align="center">
                                        <tr>
                                                <th colspan="8">Listado de Manejo</th>
                                        </tr>
                                        <tr>
                                                <th>Codigo</th>
                                                <th>Descripcion</th>
