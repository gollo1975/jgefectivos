...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <th colspan="7" class="titulo"><div align="center"><strong><b>Listado de Empleados</b> </strong></div></th>
  </tr>
  <tr>
    <td width="57">&nbsp;</td>
    <td colspan="4">&nbsp;</td>
  ...
  <tr>
    ...
    <th align="right"><strong>Cédula</strong></td>
    <th width="34">&nbsp;</td>
    <th width="471"><strong>Empleado</strong></td>
    <th width="50">&nbsp;</td>
    <th width="53">&nbsp;</td>
    <th width="53">&nbsp;</td>
    <th width="76"><strong>Documentos</strong></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2">&nbsp;</td>
  ...
  <tr id="<?php echo "ide_$i";?>" style="background-color:#F0F0F0" onmousemove="cambiar('<?php echo "ide_$i";?>','#cccccc')" onmouseout="cambiar('<?php echo "ide_$i";?>','#F0F0F0');">
    <td><div align="left"><?php echo $listarE -> cedemple;?></div></td>
    <td>&nbsp;</td>
    ...
    <td><a href="procesos.php?opc=14&codzona=<?php echo $listarE -> codzona;?>&ubicacion=<?php echo $listarE -> ubicacion;?>&codemple=<?php echo $listarE -> codemple;?>&empleado=<?php echo $listarE -> nomemple;?>_<?php echo $listarE -> nomemple1;?>_<?php echo $listarE -> apemple;?>_<?php echo $listarE -> apemple1;?>"></a></td>
    <td>&nbsp;<div align="left">
        <?php 
    ...
    <td><a href="procesos.php?opc=24&valor=<?php echo $listarE -> codemple;?>"></a></td>
    <td>&nbsp;<a href="procesos.php?opc=47&amp;valor=<?php echo $listarE -> codemple;?>"><img src="archivos.jpg" border="0" /></a></td>
  </tr>
  <?php }	?>
  <tr>
    <td>&nbsp;</td>
