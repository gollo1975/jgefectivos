...
<center><h4><u>Novedades de Nómina</u></h4></center>
 <form  action="" method="post" id="matnove">
    ...
    <table border="0" align="center">
        ...
        <tr>
                <td><b>Desde:</b></td>
                <td><input type="text" name="desde" value="<? echo date("Y-m-d");?>" size="11" maxlength="10" onfocus="ColorFoco(this.id)" onblur="QuitarFoco(this.id)" id="desde" class ="cajas">
                <td colspan="1"><b>Hasta:</b></td>
                <td><input type="text" name="hasta" value="<? echo date("Y-m-d");?>" size="11" maxlength="10" onfocus="ColorFoco(this.id)" onblur="QuitarFoco(this.id)" id="hasta" class ="cajas">
            </tr>
       <tr>
        <td><b>Documento:</b></td>
      ...
      <?
         ...
         <input type="hidden" name="codigo" value="<? echo $codigo;?>">
	       ...
	       where   novedadnomina.codnovedad=denovedanomina.codnovedad and
		       novedadnomina.codnovedad='$codnovedad' order by porcentaje";
                  ...
                  <tr class="cajas">
                   ...
                   while ($filas_s = mysql_fetch_array($resu2)):
                      ...
                      <tr class="cajas">
	                      ...
	                      <td>&nbsp;&nbsp;<a href="recargar.php?datos=<?echo $filas_s["codsala"];?>&conse=<?echo $filas_s["radicado"];?>&cedula=<?echo $cedula;?>&desde=<?echo $desde;?>&hasta=<?echo $hasta;?>&codigo=<?echo $codigo;?>"><img src="../image/mod.jpg" border="0" alt="Permite Modificar el Registro"></a></td><td>&nbsp;&nbsp;<?echo $filas_s["codsala"];?></td>
         ...
         <tr>
          <td><a href="NovedadEmpresa.php"><b><u>Regresar</u></b></td>
         </tr>
         <?
          $consulta = "select salario.codsala,salario.desala from salario  order by desala";
                             $resultado = mysql_query ($consulta) or die ("Error en la consulta 1" )?>
                                        ...
                                        <form action="cargar.php" method="post">
                                          <table border="0" align="center">
                                               <tr class="cajas">
                                                <td><br></td><td><b><u>Nro Cuenta</u></b></td><td>&nbsp;<b><u>Descripción</u></b></td>
                                                </tr>
                                                <tr>
                                                        <td><br></td>
                                                </tr>
                                                  ...
                                                  <?
                                                    ...
                                                    ?>
                                                     <tr class="cajas">
                                                       <td>&nbsp;&nbsp;<a href="cargardato.php?datos=<?echo $registro["codsala"];?>&codnovedad=<? echo $codnovedad;?>&desde=<? echo $desde;?>&hasta=<? echo $hasta;?>&cedula=<?echo $cedula;?>"><img src="../image/mod.jpg" border="0" alt="Permite agregar Registro"></a></td><td>&nbsp;&nbsp;<?echo $registro["codsala"];?></td>
