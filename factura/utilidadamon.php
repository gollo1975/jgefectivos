...
<form action="" method="post" width="200">
  ...
  <tr>
         <td><b>Servicios:</b></td>
	                      ...
	                      <?
		               $consulta_s="select codcom,concepto from item order by concepto";
...
elseif(empty($codigo)):
  ?>
  <script language="javascript">
    alert ("Despliegue la vista para seleccionar el tipo de servicio.!")
    history.back()
  </script>
    <?
else:
  ...
  $consulta="select zona.zona,factura.nrofactura,factura.fechaini,factura.fechaven,SUM(defactura.total) 'Total',zona.codzona from maestro,sucursal,zona,factura,defactura,item
   where  maestro.codmaestro=sucursal.codmaestro and
         sucursal.codsucursal=zona.codsucursal and
          ...
          item.codcom='$codigo' group by zona.zona ASC";
          ...
          if($registros!=0):
	                  ?>
	                    <table border="0" align="center">
	                     ...
	                     <tr>
	                       <td class="cajas"><b>Servicio:</b>&nbsp;<? echo $concepto;?></td>
	                     </tr>
                           </table>
                            <tr><td><br></td></tr>       
	                   <table border="0" align="center" >
	                         ...
	                         <?
	                          ...
	                          while ($filas=mysql_fetch_array($resultado)):
	                            ...
	                            ?>
	                              <tr class="cajas">
                                      <th><? echo $a;?></th>
	                              <td><a href="detalladoadmon.php?CodZona=<?echo $filas["codzona"];?>&codigo=<?echo $codigo;?>&desde=<?echo $desde;?>&hasta=<?echo $hasta;?>"><? echo $filas["codzona"];?></a></td>
