                                          ...
                                          <table border="1" align="center" width="710" >
                                            <tr><td>
                                             <table border="0" align="center" width="710" >
                                              <tr>
                                                  ...
                                                  <tr>
                                                     <td class="cajas" colspan="16"><b>Cliente:&nbsp;</b><?echo $filas["zona"];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Nit/Cedula:&nbsp;&nbsp;</b><?echo $nitzona;?>-<?echo $filas["dvzona"];?>&nbsp;&nbsp;<b>Tipo_Factura:&nbsp;</b><?echo $filas["servicio"];?></td>
                                                  </tr>
                                                  <tr>
                                                      <td class="cajas"><b>Dirección:&nbsp;</b><?echo $filas["dirzona"];?>&nbsp;&nbsp;&nbsp;<b>Teléfono:</b>&nbsp;<?echo $filas["telzona"];?>&nbsp;&nbsp;<b>Municipio:</b>&nbsp;<?echo $Xzona;?>&nbsp;&nbsp;<b>Departamento:</b>&nbsp;<?echo $filas["departamento"];?></td>
                                                   </tr>
                                                   <tr>
                                                  ...
                                                  <?
                                           $con="select defactura.*,item.puc, item.concepto from defactura,item
                                           ...
                                           if($regi==0):
                                             ...
                                             ?>
                                               ...
                                               <tr>
                                                 <tr>
												 	<td><b><div align="left">&nbsp;&nbsp;PUC</div></td>
                                               ...
                                               <?
                                                while($fila=mysql_fetch_array($resu)):
                                                 ...
                                                 $aux2=number_format($fila["cantidad"],0);
                                                  ?>
                                                  <tr>
												  	<td  class="cajas">&nbsp;&nbsp;<?echo $fila["puc"];?></td>
