<html>
        ...
        <body onLoad="imprimir()">  <!-- sirve para cargar la funcion de impresion-->
                <?
                        ...
                        $consulta="select maestro.dirmaestro,maestro.telmaestro,maestro.codigocre,cree.concepto,cree.valor,maestro.faxmaestro,maestro.codmuni 'codigo',novedadq.nota,factura.nrofactura,factura.fechaini 'fechaopcional',factura.fechaven 'fechafinal',factura.fechagra,factura.iva 'ivatotal',factura.grantotal,factura.observacion,departamento.departamento,
                                factura.resolucion 'resolu',factura.inicio,factura.final,zona.*,factura.vlrcre,factura.porcentaje,factura.rfte,factura.rteiva,factura.subtotal,sucursal.cuenta1,sucursal.cuenta2,sucursal.tipocta1,sucursal.tipocta2,sucursal.banco,sucursal.banco1,municipio.municipio,tipofactura.servicio from cree,sucursal,factura,zona,novedadq,municipio,departamento,maestro,tipofactura
                                    where maestro.codmaestro=sucursal.codmaestro and
                                          maestro.codigocre=cree.codigocre and
                                          ...
                                          factura.nroservicio=tipofactura.nroservicio and
                        ...
                        $registros=mysql_num_rows($resultado);
                         while ($filas=mysql_fetch_array($resultado)):
                              ...
                              $datoCre=number_format($valorC,2);
                              $Rfte=$filas["rfte"];
                              $codigo=$filas["codigo"];
                              $Rteiva=$filas["rteiva"];
									    ...
									    <table border="1" align="center" width="730">
                                         ...
                                         <tr> 
                                          ...
                                          <table border="0" align="center" width="730" >
                                             ...
                                             <tr>
                                               <td class="cajas" align="center"><b>Cod_Actividad:</b>&nbsp;<?echo $filas["codigocre"];?>&nbsp;<b>Descripción:</b>&nbsp;<?echo $filas["concepto"];?>&nbsp;<b>Tarifa:</b>&nbsp;<?echo $filas["valor"];?></td>
                                             </tr>
                                             <tr><td>&nbsp;</td></tr>
                                          <table border="1" align="center" width="730" >
                                            <tr><td>
                                             <table border="0" align="center" width="730" >
                                              <tr>
                                                     <td class="cajas" colspan="30" ><b><u><div align="center">Datos del Cliente[Empresa Usuaria]</div></u></b></td>
                                                  </tr>
                                                   <tr> <td colspan="30">---------------------------------------------------------------------------------------------------------------------------------------</td>
                                                   </tr>
                                                    <tr>
	                                              <td class="cajas"><b>Nit:&nbsp;</b><?echo $nitzona;?>-<?echo $filas["dvzona"];?></td>
	                                              <td class="cajas"><b>Cliente:&nbsp;</b><?echo $filas["zona"];?></td>
	                                              <td class="cajas"><b>Tipo_Factura:&nbsp;</b><?echo $filas["servicio"];?></td>
	                                           </tr>
                                                    <tr>
	                                              <td class="cajas"><b>Teléfono:&nbsp;</b><?echo $filas["telzona"];?></td>
                                                      <td class="cajas"><b>Dirección:&nbsp;</b><?echo $filas["dirzona"];?></td>
	                                              <td class="cajas"><b>Municipio:&nbsp;</b><?echo $filas["municipio"];?></td>
	                                           </tr>
                                                   <tr>
	                                              <td class="cajas"><b>Fecha_Proceso:&nbsp;</b><?echo $filas["fechagra"];?></td>
                                                      <td class="cajas"><b>Fecha_Inicio:&nbsp;</b><?echo $filas["fechaopcional"];?></td>
	                                              <td class="cajas"><b>Fecha_Vencimiento:&nbsp;</b><?echo $filas["fechafinal"];?></td>
	                                           </tr>
                                                    </table>
                                                  </tr></td>
                                                 </table>
                                             ...
                                             ?>
                                               ...
                                               <tr>
                                                 <tr>
													...
													<td><b><div align="right">Dcto&nbsp;&nbsp;</div></td>
                                               ...
                                               <?
                                                ...
                                                endwhile;
                                                 ...
                                                 <tr>
                                                    <td colspan="2"align="right" ><b>Impuesto Cree(<?echo $Valor;?>%):&nbsp;</b></td><td colspan="10"align="right" >-$.0<?echo 0;?></td>
                                                 </tr>
                                                 <tr>
                                                 ...
                                                 <tr>
                                                  ...
                                                  <tr>
                                                   ...
                                                   <tr>
                                                       <td class="cajas" align="center"><b>Cta:</b>&nbsp;<?echo $filas["tipocta1"];?>&nbsp;<b>Nro:&nbsp;</b><?echo $filas["cuenta1"];?><b>&nbsp;Banco:&nbsp;</b><?echo $filas["banco"];?>&nbsp;<b>Cta:&nbsp;</b><?echo $filas["tipocta2"];?>&nbsp;<b>Nro:</b>&nbsp;<?echo $filas["cuenta2"];?><b>&nbsp;Banco:&nbsp;</b><?echo $filas["banco1"];?></td></tr>
                                                   <tr>
												   	<td valign="middle">
													<hr>
													<img src="../image/logo.png"><b>Nuestra Compañia, en favor del medio ambiente</b>&nbsp;</td><td align="left"><img src="../image/jg.png"></td>
													</tr>
                                                 </table>
