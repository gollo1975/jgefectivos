...
<head>
  <title>Modificar Contrato temporal</title>
...
<center><h4><u>Modificar Datos</u></h4></center>
  ...
  <?
     ...
     include("../conexion.php");
	      $con1="select convenio.* from convenio where cedemple='$cedula'";
	             ...
	             <table border="0" align="center">
	               ...
	               <?
	                ...
	                while($filas=mysql_fetch_array($resu1)):
	                   ...
	                   <tr class="cajas">
	                      <th><?echo $i;?></th>
	                      <td><a href="detalladoconveniodepto.php?nro=<?echo $filas["nroconvenio"];?>"><?echo $filas["nroconvenio"];?></a></td>
