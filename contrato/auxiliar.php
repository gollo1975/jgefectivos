...
<?
 if(session_is_registered("validar")):
     ...
     $consulta="select empleado.*,zona.zona from empleado,zona where
               zona.codzona=empleado.codzona and empleado.codemple='$codemple'";
          ...
          <tr>
            ...
            <td><input type="text" name="codemple" value="<?echo $filas["codemple"];?>"readonly class="cajas"></td>
             ...
             <tr>
                 ...
                 <td><b>Fecha_Nac.:</b></td>
                   <td><input type="text" name="cuenta" value="<?echo $filas["fechanac"];?>" readonly
                      size="10" maxlength="10" class="cajas"></td>
                 </tr>
                 <td><b>Celular:</b></td>
                 ...
                 <td><b>Zona:</b></td>
                   <td><input type="text" name="celular" value="<?echo $filas["zona"];?>" readonly
