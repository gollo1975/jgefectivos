...
if (!isset($cedula)):
?>
<center><h4>Consulta de Contratos</h4></center>
...
<?
    ...
    $consulta="select empleado.nomemple,empleado.apemple  from empleado where cedemple='$cedula'";
    ...
    ?>
     <table border="0" align="center">
      ...
      if ($registro!=0):
        ...
        <table border="0"align="center">
          <tr class="cajas">
            <td>Para Modificar un contrato, Presione Click en el Nro_Contrato ..</td>
          </tr>
        </table>
        <tr><td><br></td></tr>   
        <table border="0" align="center">
          ...
          <?
             while($filas_s=mysql_fetch_array($resul)):
               ...
               ?>
               <tr class="cajas">
                 <td><a href="modificar.php?contrato=<?echo $filas_s["contrato"];?>"><?echo $filas_s["contrato"];?></a></td>
