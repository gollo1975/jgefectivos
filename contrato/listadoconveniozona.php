...
<head>
  <title>Consulta de Convenio</title>
...
?>
 ...
 <?
   ...
   <?
     ...
     ?>
<center><h4><u>Listado de Convenios</u></h4></center>
    <table border="0" align="center">
        <tr class="cajas">
...
<table border="0" align="center">
   <tr class="cajas">
    ...
    $l=1;
     ...
     <th><?echo $l;?></th>
       <?if ($ValidarTipo ==''){ ?>
         <td><a href="imprimeconveniodepto.php?codigo=<?echo $filas["nroconvenio"];?>"><?echo $filas["nroconvenio"];?></a></td>
     <?}else{?>	
