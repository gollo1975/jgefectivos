                        ...
                        else
                        {
                          ...
                          ?>
                            <table border="0" align="center" width="700">
                             <tr>
                                 <th colspan="15"></th><th class="cajas">Cedula:&nbsp;<?echo $filas["cedemple"];?>&nbsp;<b>Empleado:&nbsp;</b><?echo $filas["nomemple"];?>&nbsp;<?echo $filas["nomemple1"];?>&nbsp;<?echo $filas["apemple"];?> &nbsp;<?echo $filas["apemple1"];?></th>
                                </tr>
                              <?
                           endwhile;
                         }
