<html>
        ...
        <body onload="imprimir()">  <!-- sirve para cargar la funcion de imprsion-->
               <?
                        ...
                        $consulta="select maestro.codmaestro,maestro.dvmaestro,maestro.nomaestro,sucursal.sucursal,sucursal.dirsucursal,recibo.*,banco.bancos from maestro,sucursal,recibo,zona,banco
                        where  maestro.codmaestro=sucursal.codmaestro and
                               sucursal.codsucursal=zona.codsucursal and
                               zona.codzona=recibo.codzona and
                ...
                ?>
                          <script language="javascript">
                            alert("El recibo de pago No existe en el sistema ?")
                            history.back()
                          </script>
                <?
                        }
                ...
                ?>
                              ...
                              <tr>
                               ...
                               <tr>
                                 ...
                                 <tr>
                                 <td colspan="4" align="left"class="cajas"><b>Valor:</b>&nbsp;&nbsp;$<?echo $xlr;?></td>
                                 </tr>
                                 <tr>
                                 ...
                                 <td colspan="20" class="cajas"><b>Por Concepto de:&nbsp;</b><?echo $filas["concepto"];?></td>
                                   ...
                                   <tr><td>&nbsp;</td></tr>
                                 <tr>
                                  <td colspan="3"><div align="right"><b>DEBITO</b></div></td><td colspan="1"><div align="right"><b>CREDITO</b></div></td>
                                 </tr>
                                  <tr>
                                   <td colspan="3" class="cajas"><div align="right">$<?echo $xlr;?></div></td><td colspan="1" class="cajas"><div align="right">$<?echo $xlr;?></div></td>
                                 </tr>
                                <tr><td><br></td></tr>
                                <tr>
