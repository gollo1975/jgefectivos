...
-->
        ...
        include("../conexion.php");
         $variable="select maestro.web,maestro.dirmaestro,maestro.telmaestro,tipoprocesomemo.concepto,sucursal.dirsucursal,sucursal.telsucursal,sucursal.faxsucursal,sucursal.codmuni as codigo,sucursal.sucursal,municipio.municipio,empleado.cedemple,empleado.nomemple,empleado.nomemple1,empleado.apemple,empleado.apemple1,memorando.* from tipoprocesomemo,municipio,zona,sucursal,empleado,memorando,maestro
        ...
        if ($registro==0):
         ...
         <?
            ...
            while ($filas=mysql_fetch_array($resultado)):
               $cedemple=number_format($filas["cedemple"],0);
             ?>
               ...
               <tr>
                  <td colspan="30" rowspan="8" class="cajas"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <th height="50" bgcolor="#FFFFCC" style="border-top: 1px solid; border-right: 1px solid; border-bottom: 1px solid;"><span class="Estilo1">PROCESOS DE R&Eacute;GIMEN DISCIPLINARIO</span></th>
               ...
               <tr>
                ...
                <td width="4"></td><td width="124" class="cajas"><b>
                  <div align="center">Nro:</b>&nbsp;<?echo $filas["radicado"];?></div></td>
                </tr>
                 <tr>
                ...
                <tr class="cajas">
                 <td>&nbsp;</td>
                  ...
                  <table border="0" align="center" width="700">
                   <tr class="cajas">
                    <td colspan="40"><b>Registro : <?php echo $filas["concepto"];
													$condicion = $filas["asunto"];
					?></b></td>
                    </tr>
                 </table>
                   <table border="0" align="center" width="700">
