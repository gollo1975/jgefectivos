...
<center><h4><u>Cobro de Examenes</u></h4></center>
<form action="" method="post">
  <table border="0" align="center" width="300">
    ...
    <tr><td><br></td></tr>
        ...
        $resu=mysql_query($con)or die("Error de busqueda en la tabla zona");
        while($filas=mysql_fetch_array($resu)):
        ?>
           <option value="ListadoExamenCobrar.php?CodZona=<? echo $filas["codzona"];?>"><?echo $filas["zona"];?>
        <?
        endwhile;?>
        </select></td>
       </tr>
