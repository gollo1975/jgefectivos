      ...
      ?>
        ...
        <br>
            ...
            <div class="itemmenu">
				...
				<a href="CentroCostos/centroCostos.php" target="contenido">Crear Centro de Costos</a><Br>
            ...
            <div class="itemmenu">
                ...
                <a href="menuoperativo.php?op=curso" target="contenido">Curso en Altura</a><br>
            ...
            ?>
            <div class="itemmenu">
                <a href="menuoperativo.php?op=carta&FirmaDigital=<?echo $xsession;?>" target="contenido">Carta Laboral</a><br>			
                ...
                <a href="menuoperativo.php?op=CesaInte" target="contenido">Cesantias e Interes</a><br> 
                </div>
            <?
            }
            ?>
            ...
            <div class="itemmenu">
                ...
                <a href="menuoperativo.php?op=examen" target="contenido">Examenes de Ingreso</a><br>				
            ...
            <div class="itemmenu">
				...
				<a href="menuoperativo.php?op=confa" target="contenido">Compras</a><br>				
                <a href="menuoperativo.php?op=cursoecho" target="contenido">Curso de Alturas</a><br>				
				...
				<a href="comprobantegreso/FacturaporPagar.php" target="contenido">Facturas por Pagar</a><br>	
				...
				<a href="control/control/fachada.php?opc=71&valor='04'" target="contenido">Consulta Visitantes en Espera</a><br>		
            </div>
            <?
            }
            ?>
            ...
            ?>
            <div class="itemmenu">
                <a href="menuoperativo.php?op=aporteso" target="contenido">Aporte del Fondo</a><br>
                <a href="menuoperativo.php?op=cartal" target="contenido">Carta Laboral</a><br>
		<a href="CentroCostos/procesos.php?opc=2" target="contenido">Centro de Costos</a><br>
           ...
           <div class="lbmenu">
            ...
            if ($tipoMenu=="CONTABILIDAD")
            {
             ...
             <div class="itemmenu">
                ...
                <a href="menuoperativo.php?op=comprobantes&op1admemp" target="contenido">Tipo Comprobante</a><br>
                <a href="menuoperativo.php?op=comproegreso&Usuario=<?echo $xsession;?>" target="contenido">Comprobante de Egreso</a><br> 
           ...
           ?>
             <div class="lbmenu">
                <a href="menuoperativo.php?tipoM=SALIR"><font size=3>+</font></a>CERRAR SESION
            </div>
            <?
            if ($tipoMenu=="SALIR")
            {
