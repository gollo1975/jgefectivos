  ...
  include ("../conexion.php");
    include ("../conexion.php");
     $consulta = "select maestro.codmaestro,maestro.dvmaestro,maestro.nomaestro,sucursal.sucursal,maestro.dirmaestro,maestro.telmaestro,
        ...
        empleado.cuenta,observacion.descripcion,eps.eps,pension.pension, contrato.cargo from maestro,nomina,empleado,eps,pension,sucursal,
        zona,periodo,observacion, contrato
        where  maestro.codmaestro=sucursal.codmaestro and
               ...
               empleado.codemple = contrato.codemple
