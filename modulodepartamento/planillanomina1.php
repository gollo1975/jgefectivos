...
$con="select zona.codzona,zona.zona,zona.telzona from zona,sucursal
   ...
   sucursal.codsucursal='$codsucu' order by zona.zona";
$resu=mysql_query($con)or die("Error al buscar zonas");
$reg=mysql_num_rows($resu);
if($reg!=0):
   ?>
   <div align="center"><h4>Empresas Usuarias</h4></div>
    <table border="0" align="center">
      <tr><td class="cajas">Para exportar la planilla por fechas, Presione Click en el Campo [Cod_Zona]</td></tr>
    </table>
   <table border="0" align="center">
      <tr><td><br></td></tr>
      <tr class="cajas">
      ...
      while($filas=mysql_fetch_array($resu)):
         ?>
         <tr class="cajas">
           <td><a href="exportarplanillaegreso.php?codzona=<?echo $filas["codzona"];?>"><div align="center"><?echo $filas["codzona"];?></div></a></td>
