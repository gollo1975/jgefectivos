...
?>
  <script language="javascript">
    alert ("Digite la fecha de servicio para la empresa ?")
    history.back()
  </script>
    <?
else:
include ("../conexion.php");
      $consu="select zona.zona,zona.prestacion,zona.caja,zona.admon,zona.iva,zona.vacacion,sucursal.banco,sucursal.banco1,sucursal.cuenta1,sucursal.cuenta2,sucursal.tipocta1,sucursal.tipocta2 from zona,sucursal
