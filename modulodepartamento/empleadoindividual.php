...
?>
 ...
 <?
    ...
    {
      case 1:
        $consulta="select empleado.*,eps.eps,pension.pension,costo.centro,zona.zona from empleado,eps,pension,costo,zona,sucursal where
  ...
  <br>
   ...
   ?>
     <tr class="cajas">
      ...
      <td><a href="auxiliarempleado.php?cedemple=<?echo $filas["cedemple"];?>"><?echo $filas["cedemple"];?></a></td>
