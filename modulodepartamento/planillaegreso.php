      ...
      $consu="select zona.codzona,zona.zona,periodo.desde,periodo.hasta from zona,periodo
                where zona.codzona=periodo.codzona and
                 ...
                 while ($filas_s=mysql_fetch_array($resulta)):
                   $zona=$filas_s["zona"];
                    ?>
                    <center><h4><u>Planilla [Egresos]</u></h4></center>
                 ...
                 $registros=mysql_num_rows($resultado);
                  if($registros!=0):
                     ?>
                       <table border="0" align="center" >
                         <tr class="cajas">
                           <td class="cajas"><b>Item</b></td><td class="cajas"><b>Cedula</b></td> <td class="cajas"><b>Empleado</b></td><td class="cajas"><b>D_Mercado</b></td><td class="cajas"><b>D.Odont.</b></td><td class="cajas"><b>D_Optica</b></td><td class="cajas"><b>Pensión</b></td><td class="cajas"><b>Salud</b></td><td class="cajas"><b>A_Fondo</b></td><td class="cajas"><b>D_Gmo</b></td><td class="cajas"><b>C_Laboral</b></td><td class="cajas"><b>D_Tercero</b></td> <td class="cajas"><b>D_Vestuario</b></td><td class="cajas"><b>Emb_Aliment.</b></td><td class="cajas"><b>D_Computo</b></td><td class="cajas"><b>Men_Vlr_Pag.</b></td><td class="cajas"><b>D_Caja</b></td><td class="cajas"><b>D_Cocredito</b></td><td class="cajas"><b>D_Coopantex</b></td><td class="cajas"><b>D_Empresa</b></td><td class="cajas"><b>D_Pichincha</b></td><td class="cajas"><b>D_Funeraria</b></td><td class="cajas"><b>D_Sol</b></td><td class="cajas"><b>Rfte</b></td><td class="cajas"><b>Seg_Vida</b></td><td class="cajas"><b>D_Limocine</b></td><td class="cajas"><b>D_Atm</b></td><td class="cajas"><b>D_Budapes</b></td><td class="cajas"><b>T_Deducción</b></td>
                          </tr>
                       <?
                        $i=1;
                         $fechap=date("Y-m-d");
                        ...
                        while ($filas=mysql_fetch_array($resultado)):
                           ...
                           zona.codzona='$codzona' and
                            ...
                            /*final de codigo*/
                            $consul26="SELECT denomina.deduccion 'budapes'
                            FROM salario, denomina, nomina,zona,periodo
                            WHERE salario.codsala = denomina.codsala
                            AND nomina.consecutivo = denomina.consecutivo and
                            zona.codzona='$codzona' and
                            ...
                            zona.codzona=periodo.codzona and
                            periodo.codigo=nomina.codigo and
                            nomina.desde='$desde' and nomina.hasta='$hasta'  and denomina.codsala='88' group by denomina.codsala";
                            $resulta26=mysql_query($consul26)or die ("Consulta incorrecta 88");
                            $registro26=mysql_num_rows($resulta26);
                            $filas_s26=mysql_fetch_array($resulta26);
                            $suma25=$filas_s26["budapes"];
                            /*final de codigo*/
                            $totaldeduccion=($suma1+$suma2+$suma3+$suma4+$suma5+$suma6+$suma7+$suma8+$suma9+$suma10+$suma11+$suma12+$suma13+$suma14+$suma15+$suma16+$suma17+$suma18+$suma19+$suma20+$suma21+$suma22+$suma23+$suma24+$suma25);
                              ?>
                                       <tr class="cajas">
                                          ...
                                          <td><input type="text" name="cedula" value="<? echo $filas["cedemple"];?>" class="cajas" size="12" readonly></td>
                                           ...
                                           <td><input type="text"  value="<? echo $suma21;?>" class="cajas" size="9"></td>
                                           <td><input type="text"  value="<? echo $suma22;?>" class="cajas" size="9"></td>
                                           <td><input type="text"  value="<? echo $suma23;?>" class="cajas" size="9"></td>
                                           <td><input type="text"  value="<? echo $suma24;?>" class="cajas" size="9"></td>
                                            <td><input type="text"  value="<? echo $suma25;?>" class="cajas" size="9"></td>
                                           <td><input type="text"  value="<? echo $totaldeduccion;?>" class="cajas" size="11"></td>
                                         </tr>
                                          <?
                              $i=$i+1;
                              endwhile;
