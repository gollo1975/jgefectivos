...
if($reg!=0):
   ...
   <div align="center"><h4>Listado de Zonas(ERS)</h4></div>
    <table border="0" align="center">
      <tr><td class="cajas">Para crear el periodo de zona, Presione Click en el Campo [Cod_Zona]</td></tr>
    </table>
   <table border="0" align="center">
      <tr><td><br></td></tr>
      <tr class="cajas">
      ...
      while($filas=mysql_fetch_array($resu)):
         ?>
         <tr class="cajas">
           <td><a href="nuevanovedad.php?codzona=<?echo $filas["codzona"];?>&codigo=<?echo $codigo;?>&zona=<?echo $filas["zona"];?>"><?echo $filas["codzona"];?></a></td>
