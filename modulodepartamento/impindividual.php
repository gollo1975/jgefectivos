<html>
        ...
        <body onload="imprimir()">  <!-- sirve para cargar la funcion de impresion-->
               <?
                        ...
                        $consulta="select empleado.cedemple,empleado.nomemple,empleado.nomemple1,empleado.apemple,empleado.apemple1 from empleado
                ...
                <?
                        ...
                        else
                        {
                         ...
                         <br>
                         <?
                           $consulta_s="select empleado.cedemple,empleado.nomemple,empleado.nomemple1,empleado.apemple,empleado.apemple1,mercado.* from empleado,mercado
                            ...
                            if ($registros_s==0):
                             ?>
                              ...
                              <?
                               ...
                               <tr>
                                  <th><div align="left">Nro_Aut</div></th>
                                  <th><div align="left">F_Proceso</div></th>
                                  <th><div align="left">cupo</div></th>
                                  <th><div align="left">Estado</div></th>
                                  <th><div align="left">Autorización</div></th>
                                  <th><div align="left">Saldo</div></th>
                                  <th><div align="left">Cartera</div></th>
                                </tr>
