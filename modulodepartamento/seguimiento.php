...
if (!isset($cedula)):
  ...
  <?
   ...
   $con="select concat(nomemple,' ' ,nomemple1,' ' ,apemple,' ' , apemple1) as nombre from empleado,sucursal,zona
   ...
   if($reg!=0):
     ...
     if($reg1!=0):
        ...
        <table border="0" align="center">
        <tr>
           <td class="cajas">Presione Click en el Nro_Incap. para hacer el seguimiento</td>
        </tr>
      </table>
       <tr><td><br></td></tr>
         <table border="0" align="center" >
         ...
         while($filas=mysql_fetch_array($res1)):
           ?>
            <tr class="cajas">
               <th><?echo $a;?></th>
               <td><a href="detasegui.php?nro=<?echo $filas["nroinca"];?>&nombre=<?echo $filas_s["nombre"];?>&codigo=<?echo $codigo;?>"><?echo $filas["nroinca"];?></a></td>
        ...
        ?>
       <script language="javascript">
          alert("Este documento no existe en Sistema y/o No esta autorizado para ver este registro  ?")
         history.back()
      </script>
     <?
   endif;
