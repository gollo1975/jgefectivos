        ...
        $resulta=mysql_query($consu) or die("consulta incorrecta 1  ");
         while ($filas_s=mysql_fetch_array($resulta)):
           ...
           <table border="0" align="center" >
              <tr>
               <td colspan="5"><div align="center"><b><?php  echo $filas_s["zona"];?></b></div></td>
              </tr>
              <tr><td><br></td></tr>
              <tr class="cajas">
                <td><b>Desde:&nbsp;&nbsp;</b><?php  echo $filas_s["desde"];?></td>
                <td colspan="2"><b>Hasta:&nbsp;&nbsp;</b><?php  echo $filas_s["hasta"];?></td>
              </tr>
              <tr class="cajas">
                <td><b>Nro_Servicio:&nbsp;&nbsp;</b><?php  echo $filas_s["codigo"];?></td>
                <td><b>&nbsp;Iva:&nbsp;&nbsp;</b><?php  echo $ivag;?>%</td>
              </tr>
              <tr class="cajas">
                <td><b>&nbsp;Cesa/Prima:&nbsp;&nbsp;</b><?php  echo $presta;?>%</td>
                <td><b>&nbsp;Caja:&nbsp;&nbsp;</b><?php  echo $cajaC;?>%</td>
              </tr>
              <tr class="cajas">
                <td><b>&nbsp;Sena:&nbsp;&nbsp;</b><?php  echo $sena;?>%</td>
                <td><b>&nbsp;Icbf:&nbsp;&nbsp;</b><?php  echo $icbf;?>%</td>
              </tr>
              <tr class="cajas">
               <td><b>&nbsp;Vacaciones:&nbsp;&nbsp;</b><?php  echo $vacacion;?></td>
                <td><b>&nbsp;Admon:&nbsp;&nbsp;</b><?php  echo $datos;?></td>
              </tr>
            </table>
            <?php 
        endwhile;
        $consulta="select decobrozona.* from cobrozona,decobrozona
                 ...
                 $registros=mysql_num_rows($resultado);
                  if($registros!=0):
                     ...
                     <input type="hidden" name="ivag" value="<?php  echo $ivag;?>">
                         ...
                         <tr class="cajas">
                          ...
                          while ($filas=mysql_fetch_array($resultado)):
                            ...
                            <tr class="cajas">
                              ...
                              <td>&nbsp;<?php  echo $aux8;?></td>
                              <td>&nbsp;<?php  echo $aux9;?></td>
                              <td>&nbsp;<?php  echo $aux10;?></td>
                              <td>&nbsp;<?php  echo $aux11;?></td>
                              <td>&nbsp;<?php  echo $aux12;?></td>
                              <td>&nbsp;<?php  echo $aux13;?></td>
                              <td>&nbsp;<?php  echo $filas["nove"];?></td>
                              <td>&nbsp;<?php  echo $filas["nivelriesgo"];?>%</td>
                           ...
                           $sumatt=($tto+$totalIva);
                            ...
                            <table border="0" align="center"width="730">
                              <tr class="cajas">
                                 <td><b>Nro:</b>&nbsp;<?php  echo $suma;?>&nbsp;&nbsp;<b>&nbsp;&nbsp;Basico:</b>&nbsp;<?php  echo $con;?><b>&nbspT_Extras:</b>&nbsp;<?php  echo $con1;?><b>&nbspT_Auxilio:</b>&nbsp;<?php  echo $con2;?><b>&nbspAyuda:</b>&nbsp;<?php  echo $con3;?><b>&nbsp;Arp:</b>&nbsp;<?php  echo $con4;?><b>&nbsp;Eps:</b>&nbsp;<?php  echo $con5;?><b>&nbsp;Pensión:</b>&nbsp;<?php  echo $con6;?><b>&nbsp;Caja</b>&nbsp;<?php  echo $con7;?><b>&nbsp;Sena:</b>&nbsp;<?php  echo $con8;?><b>&nbspIcbf:</b>&nbsp;<?php  echo $con9;?><b>&nbsp;Cesa/Prima:</b>&nbsp;<?php  echo $con10;?><b>&nbsp;Vacación:</b>&nbsp;<?php  echo $con11;?><b>&nbsp;Admon:</b>&nbsp;<?php  echo $con12;?><b>&nbspIva:</b>&nbsp;<?php  echo $con13;?></td>
                              </tr>
                            </table>
                            </table>
                            <tr><td><br></td></tr>
                            <table border="0" align="center">
                              <tr class="cajas">
                                 <td><b>Total:</b>&nbsp;<?php  echo $total;?><b>&nbsp;&nbsp;Incapacidades:</b>&nbsp;<?php  echo $incapacidad;?><b>&nbspAnticipo:</b>&nbsp;<?php  echo $anticipo;?><b>&nbspOtros Dcto:</b>&nbsp;<?php  echo $otros;?><b>&nbsp;Ajuste:</b>&nbsp;<?php  echo $ajuste;?><b>&nbsp;Menor Vlr Fac.:</b>&nbsp;<?php  echo $menorvlr;?></td>
                              </tr>
                            </table>
                            <table border="0" align="center">
                              <tr>
                                <td><b>SubTotal:</b>&nbsp;<?php  echo $tto;?></t>
                              </tr>
                              <tr>
                                <td><b>Iva:</b>&nbsp;<?php  echo $totalIvaA;?></t>
                              </tr>
                              <tr>
                                <td><b>Gran Total:</b>&nbsp;<?php  echo $sumatt;?></t>
                              </tr>
                            </table>
                             <center><dt class="cajas">Cta de<b> <?php  echo $valor;?></b>&nbsp;Nro&nbsp;<b><?php  echo $cuenta1;?>&nbsp;</b>de</b><b>&nbsp;<?php  echo $banco1;?></b>&nbsp o&nbspCta <b><?php  echo $valor1;?></b>&nbsp;Nro&nbsp;<b><?php  echo $cuenta2;?>&nbsp;</b>de</b><b>&nbsp;<?php  echo $banco2;?></b></td></center>
                            <?php 
                   else:
                      ?>
                         <script language="javascript">
