        ...
        <table border="0" align="center">
         <tr class="fondo">
          ...
          <tr>
            ...
            <td><input type="text" name="codemple" value="<?echo $filas["codemple"];?>"readonly size="7"class="cajas"></td>
            </tr>
             <tr>
                   <td><b>Cédula:</b></td>
                 ...
                 <td><b>Apellido 2:</b></td>
                   <td><input type="text"  value="<?echo $filas["apemple1"];?>" readonly size="20" class="cajas"></td>
                 </tr>
                 <tr>
                   <td><b>Dirección:</b></td>
                 ...
                 <td><b>Nivel_Arp:</b></td>
                   <td><input type="text"  value="<?echo $filas["nivel"];?>" size="6" readonly
                      size="45"  class="cajas"></td>
                 </tr>
                  <td><b>%Eps:</b></td>
                   <td><input type="text"  value="<?echo $filas["eps"];?>" size="6" readonly
                      size="45"  class="cajas"></td>
                 </tr>
                  <td><b>%Pensión:</b></td>
                   <td><input type="text"  value="<?echo $filas["pension"];?>" size="6" readonly
                      size="45"  class="cajas"></td>
                 </tr>
