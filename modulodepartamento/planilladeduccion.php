...
if($reg!=0):
   ?>
   <div align="center"><h4><u>Empresas Usuarias</u></h4></div>
    <table border="0" align="center">
      <tr><td class="cajas">Para ver las planillas de egreso por zona, Presione Click en el Campo [Cod_Zona]</td></tr>
    </table>
   <table border="0" align="center">
      <tr><td><br></td></tr>
      <tr class="cajas">
      ...
      while($filas=mysql_fetch_array($resu)):
         ?>
         <tr class="cajas">
           <td><a href="planillaegreso.php?codzona=<?echo $filas["codzona"];?>"><div align="center"><?echo $filas["codzona"];?></div></a></td>
