<html>
        ...
        include("../conexion.php");
         $variable="select sucursal.dirsucursal, sucursal.telsucursal, sucursal.faxsucursal, municipio.municipio, empleado.cedemple, empleado.nomemple, empleado.nomemple1, empleado.apemple, empleado.apemple1, memorando.* from municipio, zona, sucursal, empleado, memorando where
         ...
         <?
            ...
            while ($filas=mysql_fetch_array($resultado)):
             ?>
               ...
               <img src="../image/logounico.png" border="0" heigth="120" width="150">
                <tr>
                ...
                <tr>
                     <td colspan="30"><b>PBX:&nbsp;</b><?echo $filas["telsucursal"];?></td>
                </tr>
