  ...
  <form action="" method="post" >
     <table border="0" align="center">
       ...
       <td><b>Proveedor:</b></td>
          ...
          <?
            $consulta_s="select provedor.nomprove,provedor.nitprove from provedor order by nomprove";
...
elseif(empty($provedor)):
  ...
  <?
    ...
    include("../conexion.php");
    $con1="select examen.*,zona.zona from examen,provedor,zona
    ...
    $res1=mysql_query($con1)or die ("Error al buscar de recibos ?");
