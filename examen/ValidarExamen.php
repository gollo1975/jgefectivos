...
<?
   ...
   where examen.cedula='$cedemple' and examen.validadoso='NO'";
   ...
   if($reg!=0):
      ...
      while($filas=mysql_fetch_array($resu)):
        $Nro=$filas["nro"];
         ...
         ?>
          <tr class="cajas">
             <th><?echo $a;?></th>
             <td><a href="ValidadoExitoso.php?NroExamen=<?echo $filas["nro"];?>&Estado=<?echo $filas["validadoso"];?>&CodUsuario=<?echo $CodUsuario;?>"><div align="center"><?echo $filas["nro"];?></div></a></td>
     ...
     <?
      ...
      ?>
       <script language="javascript">
          alert("Este examen ya esta Validado en Sistema.!")
          history.back()
       </script>
      <?
   endif;
