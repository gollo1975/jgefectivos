...
include ("../conexion.php");
               ...
               $consulta="select decobrozona.*from decobrozona
			   where decobrozona.codigo= '$codigo' order by decobrozona.empleado ";
                     ...
                     ?>
                        <table border="0" align="center" >
                         <tr class="cajas">
                            ...
                            <td style='font-weight:bold;font-size:1.0em;'>Tiempo_NP</td>
                            ...
                            <td style='font-weight:bold;font-size:1.0em;'>Cesa/Primas</td>
                            <td style='font-weight:bold;font-size:1.0em;'>Vacación</td>
							<td style='font-weight:bold;font-size:1.0em;'>A_Parafiscal</td>
                            <td style='font-weight:bold;font-size:1.0em;'>Admon</td>
                            <td style='font-weight:bold;font-size:1.0em;'>Novedad_Ingreso</td>
                            <td style='font-weight:bold;font-size:1.0em;'>Novedad_Retiro</td>
                            <td style='font-weight:bold;font-size:1.0em;'>Horas_Inca_General</td>
                            <td style='font-weight:bold;font-size:1.0em;'>Horas_Inca_Laboral</td>
                          ...
                          while ($filas=mysql_fetch_array($resultado)):
                           /* $aux=number_format($filas["basico"],0);
                            ...
                            <tr class="cajas">
                              ...
                              <td><div align="right"><? echo $filas["novedadingreso"];?></div></td>
                              <td><div align="right"><? echo $filas["novedadretiro"];?></div></td>
