...
?>
   <center><h4><u>Ingreso General</u></h4></center>
 ...
 elseif(empty($campo)):
   ...
   <?
                ...
                include("../conexion.php");
                $consulta="select zona.zona,empleado.*,municipio.municipio 'municip' ,contrato.salario,contrato.fechainic,contrato.cargo,contrato.fechater,eps.eps,pension.pension from maestro,sucursal,eps,pension,zona,empleado,contrato, municipio
                        where maestro.codmaestro=sucursal.codmaestro and
							 ...
							 municipio.codmuni = empleado.codmuni and
                             contrato.fechainic between '$desde' and '$hasta' and
                             maestro.codmaestro='$campo'  order by empleado.nomemple,empleado.nomemple1,empleado.apemple,empleado.apemple1";
