<html>
        ...
        <?
                ...
                $consulta="select zona.zona,empleado.*,banco.bancos, municipio.municipio as muni,costo.centro,contrato.salario,
  contrato.fechainic,contrato.cargo,eps.eps,pension.pension as nombrep,sucursal.codsucursal
  from eps,pension,zona,empleado,contrato,sucursal, municipio,costo, banco
               ...
               <?
					...
					<td style='font-weight:bold;font-size:1.1em;'>Codigo</td>
										...
										<td style='font-weight:bold;font-size:1.1em;'>Periodo</td>
                                        <td style='font-weight:bold;font-size:1.1em;'>Salario</td>
										<td style='font-weight:bold;font-size:1.1em;'>Tipo_Jornada</td>
										<td style='font-weight:bold;font-size:1.1em;'>Salario Base</td>
