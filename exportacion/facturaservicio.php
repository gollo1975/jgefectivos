                       ...
                       <table border="0" align="center" >
                         ...
                         <?
                          while ($filas=mysql_fetch_array($resultado)):
                            ?>
                              <tr class="cajas">
                              <td><a href="detalladozonaconsultaTE.php?codigo=<? echo $filas["codigo"];?>&campo=<?echo $campo;?>&admon1=<?echo $admon1;?>&social1=<?echo $social1;?>&ivag=<? echo $ivag;?>&valor=<?echo $valor;?>&valor1=<?echo $valor1;?>&cuenta1=<? echo $cuenta1;?>&cuenta2=<? echo $cuenta2;?>&presta=<? echo $presta;?>&caja=<? echo $caja;?>&banco=<? echo $banco;?>&banco1=<? echo $banco1;?>">TE</a></td>
                              <td><a href="detalladozonaconsulta.php?codigo=<? echo $filas["codigo"];?>&campo=<?echo $campo;?>&admon1=<?echo $admon1;?>&social1=<?echo $social1;?>&ivag=<? echo $ivag;?>&valor=<?echo $valor;?>&valor1=<?echo $valor1;?>&cuenta1=<? echo $cuenta1;?>&cuenta2=<? echo $cuenta2;?>&presta=<? echo $presta;?>&caja=<? echo $caja;?>&banco=<? echo $banco;?>&banco1=<? echo $banco1;?>"><? echo $filas["codigo"];?></a></td>
