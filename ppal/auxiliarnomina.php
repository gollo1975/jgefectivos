...
<form action="" method="post" width="200">
  ...
  <tr><td><br></td></tr>
   <tr>
    <td colspan="2">
      <input type="submit" value="Buscar" class="boton" id="buscar">
    </th>
  </tr>
</table></td></tr>
</table>
                           ...
                           <table border="0" aling="center" width="714">
                             ...
                             <table border="0" align="center" width="714" >
                               ...
                               ?>
                                ...
                                <td class="cajasletras"><div align="left"><b>Pag:&nbsp;<?echo $K;?></div><div align="center"><b>Totales:</b>&nbsp;<b>Nro_Horas:</b>&nbsp;<?echo $Thora;?>&nbsp;&nbsp;&nbsp;&nbsp;<b>Ded.:</b>&nbsp;<?echo $Td;?>&nbsp;<b>Deven.:</b>&nbsp;$<?echo $Ts;?>&nbsp;<b>Pagar:</b>&nbsp;$<?echo $Tp;?></div></td>
                               </table>
