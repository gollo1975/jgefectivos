...
if (!isset($valor)):
     ?>
     <center><h4>Consulta de Vacaciones</h4></center>
...
?>
 ...
 <?
    ...
    $opcion=" select empleado.cedemple,empleado.nomemple,empleado.nomemple1,empleado.apemple,empleado.apemple1 from empleado,zona
    ...
    if ($reg!=0):
      ...
      $consulta="select vacacion.* from empleado,vacacion where
       ...
       open("vacaciones.php","_self")
        ...
        ?>
          <script language="javascript">
             alert("El documento digitado no existe en Sistema, o no esta autorizado para ver este registro ?")
             open("vacaciones.php","_self")
          </script>
        <?
     endif;
