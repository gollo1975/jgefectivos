...
?>
     ...
     <?
         ...
         $nueva=strtoupper($nueva);
          ...
          $cons="select accesozona.* from accesozona where clave='$actual'";
          $re=mysql_query($cons)or die ("Error de consulta");
          $reg=mysql_num_rows($re);
          if ($reg!=0):
             $consulta="update accesozona set clave='$nueva' where usuario='$usuario' and clave='$Clave' and cedula='$Documento'";
