...
<?
  if (!isset($campo)):
  ?>
<center><h4>Fondo de Aporte</h4></center>
...
?>
 ...
 <?
    ...
    $consu="select empleado.nomemple,empleado.nomemple1,empleado.apemple,empleado.apemple1 from empleado,zona
    ...
    if ($reg==0):
       ...
       <?
        ...
        <tr class="cajas">
         <td><b>Empleado:&nbsp;</b><?echo $filas_s["nomemple"];?>&nbsp;<?echo $filas_s["nomemple1"];?>&nbsp;<?echo $filas_s["apemple"];?>&nbsp;<?echo $filas_s["apemple1"];?></td>
          ...
          <center><h4>Listado de aportes</h4></center>
           <table border="1" align="center">
            ...
            <tr class="cajas">
             ...
             ?>
             <tr class="cajas">
               <td> <a href="imprimiraporte.php?nroentrega=<?echo $filas["nroentrega"];?>"><?echo $filas["nroentrega"];?></a></td>
