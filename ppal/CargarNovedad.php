...
if($registro!=0):
   ...
   ?>
    ...
    <form action="GrabarNovedadNomina.php" name="f1" id="f1" method="post" width="420">
     ...
     <input type="hidden" name="Cedula" value="<? echo $cedula;?>" size="11">
        ...
        <td colspan="5"> <input type="text" name="nombre" value="<? echo $nombres;?>&nbsp;<? echo $apellidos;?>" readonly="yes" size="55" onfocus="ColorFoco(this.id)" onblur="QuitarFoco(this.id)" id="nombre" class="cajas" ></td>
            ...
            <td colspan="5"><input type="text" name="codzona" value="<?echo $codigo;?>" size="3" maxlength="3" onfocus="ColorFoco(this.id)" onblur="QuitarFoco(this.id)" id="codzona" readonly=yes class ="cajas">
                <input type="text" name="zona" value="<?echo $zona;?>" size="48" onfocus="ColorFoco(this.id)" onblur="QuitarFoco(this.id)" id="zona" readonly=yes class ="cajas">
            </tr>
        <tr>
        <td><b>Desde</b></td>
        <td><input type="text" name="desde" value="<? echo $desde;?>" size="11" maxlength="10" onfocus="ColorFoco(this.id)" onblur="QuitarFoco(this.id)" id="desde" readonly=yes class ="cajas">
        <td colspan="1"><b>Hasta:</b></td>
        <td><input type="text" name="hasta" value="<? echo $hasta;?>" size="11" maxlength="10" onfocus="ColorFoco(this.id)" onblur="QuitarFoco(this.id)" id="hasta" readonly=yes class ="cajas">
        </tr>
        <tr>
        <?
        if($SwR==1){?>
        ...
        <td><b>Observación:</b></td>
          <td colspan="5"><textarea name="observacion" value="" cols="55" rows="3" class="cajas" onfocus="ColorFoco(this.id)" onblur="QuitarFoco(this.id)" id="observacion"><?echo $Mensaje;?></textarea></td></tr>
        <tr>
        </table>
