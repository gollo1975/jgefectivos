                  ...
                  <tr class="cajas">
                   ...
                   while ($filas_s = mysql_fetch_array($resu2)):
                      ...
                      <tr class="cajas">
	                      ...
	                      <td>&nbsp;&nbsp;<a href="recargar.php?datos=<?echo $filas_s["codsala"];?>&conse=<?echo $filas_s["radicado"];?>&cedemple=<?echo $cedula;?>&desde=<?echo $desde;?>&hasta=<?echo $hasta;?>&codigo=<?echo $codigo;?>"><img src="../image/mod.jpg" border="0" alt="Permite Modificar el Registro"></a></td><td>&nbsp;&nbsp;<?echo $filas_s["codsala"];?></td>
