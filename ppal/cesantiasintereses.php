...
?>
 ...
 <?
    ...
    {
      case 1:
          $consulta="select prestacion.* from prestacion,empleado,zona where
...
<tr>
  ...
  <tr class="cajas">
   ...
   ?>
     ...
     <th><?echo $a;?></th>
       <td><a href="../vacaciones/imprimirpresta.php?nropresta=<?echo $filas["nropresta"];?>"><div align="center"><?echo $filas["nropresta"];?></div></a></td>
