...
if (!isset($valor)):
    ...
    <form action="" method="post">
      ...
      <tr>
         ...
         <td><input type="text" name="valor" value="" size="15" maxlength="15"></td>
       </tr>
       <tr><td><br></td></tr>
      <tr>
        <td colspan="2">
...
?>
 ...
 <?
    ...
    $opcion=" select empleado.cedemple,empleado.cedemple,empleado.nomemple,empleado.nomemple1,empleado.apemple,empleado.apemple1
      from zona,empleado
      where zona.codzona=empleado.codzona and
      zona.codzona='$codigo'and
      empleado.cedemple='$valor'";
    $re=mysql_query($opcion)or die ("Error al buscar documento");
    ...
    if ($reg!=0):
      ...
      $consulta="select prima.* from empleado,prima where
       ...
       open("conprimaindi.php","_self")
        ...
        ?>
          <script language="javascript">
             alert("El documento digitado no existe en Sistema/  o no esta autorizado para esta consulta ?")
            open("prima.php","_self") 
          </script>
        <?
     endif;
 endif;
