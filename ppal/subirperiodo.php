<html>
  ...
  include("../conexion.php");
    $consulta="select zona.codzona,zona.zona from zona where codzona='$codigo'";
    ...
    <?
             ...
             ?><center><h4><u>Periodo de Novedades</u></h4></center><?
               ...
               ?>
                 ...
                 <form action="guardarperiodo.php" method="post" id="matfirma">
                   ...
                   <tr><td><br></td></tr>
                     <tr>
                       <td><b>Cod_Zona:</b></td>
                       <td colspan=3><input type="text" value="<?echo $filas["codzona"];?>" size="3" name="codzona" readonly class="cajas"></td>
                     </tr>
                     <tr>
                       <td><b>Zona:</b></td>
