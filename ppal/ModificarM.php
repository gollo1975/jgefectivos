...
include("../conexion.php");
  ...
  if($reg==0):
     ...
     $reg1 = mysql_num_rows($resu1);
      if($reg1==0):
         ...
         <input type="hidden" name="CodNomina" value="<? echo $codnovedad;?>">
            <table border="0" align="center">
                ...
                <td colspan="1"><input type="text" name="fechap" value="<?echo $filas["fechap"];?>" readonly="yes" size="11" class ="cajas"></td>
               </tr>
                <tr>
                <td><b>Empleado:</b></td>
               ...
               <tr>
                        ...
                        <td colspan="5"><textarea name="observacion" value="" cols="55" rows="3" class="cajas" onfocus="ColorFoco(this.id)" onblur="QuitarFoco(this.id)" id="observacion"><?echo $filas["nota"];?></textarea></td></tr>
                     <tr>
                <tr>
                  <td colspan="2">
         ...
         <?
          ...
          and empleado.cedemple='$cedula' and decentro.estado='SI'";
      ...
      <tr>
          <td><a href="NovedadM.php?codigo=<?echo $codzona;?>&desde=<?echo $desde;?>&hasta=<?echo $hasta;?>"><b><u>Regresar</u></b></td>
         </tr>
         <?
    endif;
endif;
