<html>
        ...
        include("../conexion.php");
         $variable="select municipio.municipio,sucursal.dirsucursal,maestro.telmaestro,sucursal.sucursal,maestro.faxmaestro,empleado.cuenta,prima.* from maestro,municipio,zona,sucursal,empleado,prima where
            ...
            $total=number_format($filas["total"],0);
             ?>
               ...
               <img src="../image/logounico.png" border="0" heigth="130" width="135">
                ...
                <tr class="cajas">
                <td colspan="15"><b>Fecha_Proceso:</b>&nbsp;<?echo $filas["fechap"];?></td><td colspan="10"><b>Fecha_Inicio:</b>&nbsp;<?echo $filas["fechainicio"];?></td>
                </tr>
                <tr class="cajas">
                <td colspan="15"><b>Fecha_Corte:</b>&nbsp;<?echo $filas["fechacorte"];?></td><td colspan="8"><b>Dias:</b>&nbsp;<?echo $filas["dias"];?></td><td colspan="5"><b>Ibc:</b>&nbsp;$<?echo $salario;?></td><td colspan="8"><b>&nbsp;&nbsp;&nbsp;&nbsp;Vlr_Pagado:</b>&nbsp;$<?echo $total;?></td>
                </tr>
                <tr class="cajas">
                 <td colspan="15"><b>Cuenta:</b>&nbsp;<?echo $filas["cuenta"];?></td><td colspan="20"><b>Sucursal:</b>&nbsp;<?echo $filas["sucursal"];?></td>
                  ...
                  <tr class="cajas" align="center">
                     <td colspan="50">COLOMBIA - &nbsp;<?echo $filas["municipio"];?>&nbsp;&nbsp;<?echo $filas["dirsucursal"];?>&nbsp;&nbsp; PBX:&nbsp;<?echo $filas["telmaestro"];?>&nbsp;Fax:&nbsp;<?echo $filas["faxmaestro"];?></td>
                </tr>
                 </table>
                 </td></tr>
               </table>
