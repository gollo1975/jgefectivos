               ...
               <?
                        ...
                        $registros=mysql_num_rows($resultado);
                         while ($filas=mysql_fetch_array($resultado))
                            ...
                            ?>
                              <table border="1" align="center" width="718" height="486" >
                              <tr>
                              <td>
                              <table border="0" align="center"width="718" >
                              <tr class="cajasletras"><td colspan="60"><?echo $filas["descripcion"];?></td></tr>
                              <tr>
                               <th colspan="25"align="center" class="cajas">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>EXTRACTO DE COMPENSACIONES</u></th><td colspan="25" class="cajas"><b>Nro_Extracto:</b>&nbsp;<?echo $filas["consecutivo"];?></td>
                                </tr>
                               <tr><td><br></td></tr>
                               <tr>
                                ...
                                <tr class="cajasletras">
                                 <td colspan="12" ><b>Sucursal:</b>&nbsp;<?echo $filas["sucursal"];?></td><td colspan="10" ><b>Cod_Periodo:</b>&nbsp;<?echo $filas["codigo"];?></td><td colspan="10" ><b>Comp_Ord.:</b>&nbsp;$<?echo $basico;?></td>
                                 </tr>
                                 <tr class="cajasletras">
                                 ...
                                 <tr class="cajasletras">
                                 <td colspan="12" ><b>Documento:</b>&nbsp;<?echo $filas["cedemple"];?></td><td colspan="17" ><b>Asociado:</b>&nbsp;<?echo $filas["nomemple"];?>&nbsp;<?echo $filas["nomemple1"];?>&nbsp;<?echo $filas["apemple"];?>&nbsp;<?echo $filas["apemple1"];?></td><td colspan="10" ><b>Cuenta:</b>&nbsp;<?echo $filas["cuenta"];?></td>
                                 </tr>
                                 <tr class="cajasletras">
                                 <td colspan="20" ><b>ERS:</b>&nbsp;<?echo $filas["zona"];?></td><td colspan="10" ><b>Desde:</b>&nbsp;<?echo $filas["desde"];?></td><td colspan="10" ><b>Hasta:</b>&nbsp;<?echo $filas["hasta"];?></td>
                                 </tr>
                                 <tr class="cajasletras">
                                 <td colspan="12" ><b>Fecha_Proceso:</b>&nbsp;Medellín&nbsp;<?echo $filas["fechap"];?></td><td colspan="10" ><b>Fecha_Imp:</b>&nbsp;<?echo date("Y-m-d");?></td>
                                 </tr>
                                      <?
                        ...
                        if($reg==0):
                          ...
                          <?
                           ...
                           ?>
                           <table border="1" aling="center" width="712">
                             <tr>
                             <td>
                             <table border="0" align="center" width="712">
                               ...
                               <tr class="cajasletras">
                               <td width="720" align="center"><b>Dirección:</b>&nbsp;&nbsp;<?echo $direccion;?><b>&nbsp;Tel:</b>&nbsp;&nbsp;<?echo $tele;?><b>&nbsp;Fax:</b>&nbsp;&nbsp;<?echo $fax;?></td>
                               </tr>
                               <?
                         endif;
                           ?>
