<html>
        ...
        include("../conexion.php");
         $variable="select sucursal.dirsucursal,sucursal.telsucursal,sucursal.faxsucursal,municipio.municipio,empleado.cuenta,vacacion.* from zona,sucursal,empleado,vacacion,municipio where
         ...
         <?
            ...
            $valor=number_format($filas["valor"],0);
             ?>
               ...
               <img src="../image/logounico.png" border="0" heigth="150" width="130">
                <tr>
                 <td colspan="1" class="cajas"><td></td><td colspan="20" align="center"><b><u>EXTRACTO DE VACACIONES</u></b></td><td colspan="20"><td class="cajas"><b>Nro:</b>&nbsp;<?echo $filas["codvaca"];?></td>
                </tr>
                 <td><td><br></td></tr>
                 <tr class="cajas">
                ...
                <tr class="cajas">
                  <td width="10"></td><td colspan="20"><b>Empleado:</b>&nbsp;<?echo $filas["nombre"];?></td>
                </tr>
                <tr class="cajas">
