...
?>
   ...
   <div style="width: 100%; margin: 0 auto" id="tabs">
	 ...
	 <li><a href="#tabs-2"><font color="#008040"><b>Contrato Laboral</b></font></a></li>
         ...
         <?if($codigo == ''){?>
            <li><a href="#tabs-5"><font color="#008040"><b>Llegadas tardes</b></font></a></li>
         <?}?>
     </ul>
     <div id="tabs-1">
  ...
  <div id="tabs-2">
     <table border="0" align="center" width="100%">
		...
		<?
                $t=1;
                include("../conexion.php");
	         $Contrato="SELECT contrato.*,tipocontrato.concepto,sso_tipo_cotizante.nombre,sso_subtipo_cotizante.nombre as Cotizante,caja.nombre as CajaC FROM empleado,contrato,tipocontrato,sso_tipo_cotizante,sso_subtipo_cotizante,caja WHERE
                   empleado.codemple=contrato.codemple and
                   contrato.tipo=tipocontrato.tipo and
                   contrato.codigo_tipo_cotizante_fk = sso_tipo_cotizante.codigo_tipo_cotizante_pk and
                   sso_subtipo_cotizante.codigo_subtipo_cotizante_pk = contrato.codigo_subtipo_cotizante_fk and
                   caja.codigo_caja_pk = contrato.codigo_caja_pk and
		...
		while($Registro=mysql_fetch_array($resC)){
		    echo "<tr  class='cajas'>";
                    echo "<th>" . $t . "</th>";
		    echo "<td style='text-aign: center;width: 50px'>" . $Registro['contrato'] . "</td>";
                    echo "<td style='width: 490px'>" . $Registro['concepto'] . "</td>";
		    echo "<td style='text-align: center;width: 75px'>" . $Registro['fechainic'] . "</td>";
                    echo "<td style='text-align: center;width: 90px'>" . $Registro['fechater'] . "</td>";
                    echo "<td style='text-align: right;width: 80px'>" . number_format($Registro['salario'],0) . "</td>";
                    echo "<td style='text-align: left;width: 50px'>" . $Registro['nivel'] . "</td>";
                    echo "<td style='text-align: left;width: 50px'>" . $Registro['eps'] . "</td>";
                    echo "<td style='text-align: left;width: 50px'>" . $Registro['pension'] . "</td>";
                    echo "<td style='text-align: left;width: 550px'>" . $Registro['cargo'] . "</td>";
                    echo "<td style='text-align: left;width: 500px'>" . strtoupper($Registro['nombre']) ."</td>";
                    echo "<td style='text-align: left;width: 500px'>" . strtoupper($Registro['Cotizante']) ."</td>";
                     echo "<td style='text-align: left;width: 500px'>" . strtoupper($Registro['CajaC']) ."</td>";
...
<div id="tabs-3">
            ...
            while($Registro=mysql_fetch_array($resE)){
			    ...
			    echo "<tr  class='cajas'>";
	                    ...
	                    echo "<td style='text-align: center;width: 250px'>" . $Registro['nombreDependencia'] . "</td>";
                            if($Hora >= $HoraEntrada){
                                  echo "<td style='text-align: left;width: 100px;'>" . $Salir . "</td>";
                            }else{
                                  echo "<td style='text-align: left;width: 100px; background: red'>" . $Llegar . "</td>";
                            }
                            echo "</tr>";
	                  $t=$t + 1;
	    }
  ...
  <tr>&nbsp;</td>
  <div align="center"><a href="DetalleMaestroEmpleado.php?codigo=<?echo $codigo;?>"><img src="../image/regresar.png" border="0" alt="Regresar al menu de consulta"></div>
<?
}
?>
</body>
