...
if (!isset($Cedula)){
     ?>
     <center><h4><u>MAESTRO DOCUMENTOS EMPLEADO</u></h4></center>
...
<?
      ...
      if($Cedula !=''){
          ...
          $consulta="select empleado.nomemple,empleado.nomemple1,empleado.apemple,empleado.apemple1 from empleado where
              ...
              $consulta="select empleado.nomemple,empleado.nomemple1,empleado.apemple,empleado.apemple1 from empleado,zona,sucursal where
              ...
              if ($registro!=0){
                  ...
                  <table border="0" align="center">
                   ...
                   while($filas_s=mysql_fetch_array($resulta)){
   	                ...
   	                <tr  class="cajas">
                            <th><?echo $i;?></th>
                            <td><a href="DetalleMaestroEntregaDocumento.php?Cedula=<?echo $Cedula;?>&codigo=<?echo $codigo;?>"><?echo $Cedula;?></a></td>
            ...
            <center><h4><u>Resultado de la Consulta</u></h4></center>
                  ...
                  <table border="0" align="center">
                   ...
                   while($filas_s=mysql_fetch_array($resulta)){
   	                ...
   	                <tr  class="cajas">
                            <th><?echo $i;?></th>
                            <td><a href="DetalleMaestroEntregaDocumento.php?Cedula=<?echo $filas_s["cedemple"];?>&codigo=<?echo $codigo;?>"><?echo $filas_s["cedemple"];?></a></td>
                            <td><?echo $filas_s["Empleado"];?></td>
                            <td><?echo $filas_s["zona"];?></td>
