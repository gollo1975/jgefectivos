...
<form id="form1" name="form1" method="post" action="">
  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="131"><strong>Requisito</strong></td>
    ...
    <tr>
      <td colspan="4"><textarea name="respuesta" cols="75" rows="6" id="respuesta"><?php echo $listarS -> respuesta;?></textarea></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><strong>Fecha</strong></td>
      <td><input name="fechaTerminacion" type="text" id="fechaTerminacion" value="<?php echo $listarS -> fechaTerminacion;?>" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input type="submit" name="Submit" value="Procesar" />      </td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
  </table>
