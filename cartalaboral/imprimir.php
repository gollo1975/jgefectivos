...
if(session_is_registered("xsession")):
  include("../conexion.php");
     $variable="select sucursal.sucursal,maestro.dirmaestro,maestro.telmaestro,municipio.municipio,maestro.web,maestro.faxmaestro,empleado.cedemple,empleado.nomemple,empleado.apemple,carta.* from maestro,municipio,zona,sucursal,empleado,carta where
            ...
            while ($filas=mysql_fetch_array($resultado)):
             ?>
               <table border="0" align="center" width="710">
                 <td class="cajas">&nbsp;<?echo $filas["sucursal"];?>&nbsp;<?echo $filas["codigo"];?></td>
                 </tr>
                <tr>
                 <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                  ...
                  <tr>
                   ...
                   <td>&nbsp;</td>
                    ...
                    <tr>
                    <td colspan="100" class="cajas"><div align="center"><?echo $filas["municipio"];?>,&nbsp;ANTIOQUIA&nbsp;&nbsp;<?echo $filas["dirmaestro"];?>&nbsp;&nbsp; PBX:&nbsp;<?echo $filas["telmaestro"];?>&nbsp;FAX:&nbsp;<?echo $filas["faxmaestro"];?></div></td>
                   </tr>
                   <tr>
                   <td colspan="25" class="cajas"><div align="center"><?echo $filas["web"];?></div></td>
                   </tr>
                </table>
               </table>
             <?
