...
<head>
<title>Programaciones de Prestaciones</title>
...
<center><h4><u>Programacion de Pago</u></h4></center>
  ...
  <?
   ...
   ?>
     ...
     include("../conexion.php"); 
          $consulta="select programarprestacion.* from maestro,programarprestacion
              where maestro.codmaestro=programarprestacion.codmaestro and
                    programarprestacion.fechap between '$Desde' and '$Hasta' and
                   maestro.codmaestro='$campo' order by programarprestacion.fechap DESC" ;
       $resultado=mysql_query($consulta)or die ("Error al busca informacion");
       $registro=mysql_num_rows($resultado);
       if ($registro==0):
          ?>
          <script language="javascript">
           alert("No hay programaciones de prestaciones lista.!")
           history.back()
          </script>
        <?
       else:
               ...
               <tr>
                ...
                <table border="0" align="center">
                  ...
                  while($filas=mysql_fetch_array($resultado)):
                    ...
                    <tr  class="cajas">
                        <th><?echo $suma;?></th>
                         <td><a href="ImprimirProgramarPrestacion.php?IdPrograma=<?echo $filas["idprogramapresta"];?>"><div align="center"><?echo $filas["idprogramapresta"];?></div></a></td>
