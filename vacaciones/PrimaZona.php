...
<form action="" method="post">
  <table border="0" align="center" width="300">
    ...
    <tr><td><br></td></tr>
        ...
        <?$con="select zona.codzona,zona.zona from zona where zona.estado='ACTIVA' and zona.nomina='SI' and tiponegociacion='MISIONAL' order by zona.zona";
        $resu=mysql_query($con)or die("Error de busqueda de zonas");
        while($filas=mysql_fetch_array($resu)):
       ?>
         <option value="DetalladoPrimaSemestral.php?CodZona=<? echo $filas["codzona"];?>"><?echo $filas["zona"];?>
        <?
        endwhile;?>
               </select></td>
       </tr>
