...
$ConT="select prestacion.nropresta from prestacion,detalleprestacion
             ...
             $comfenalco=number_format($filas["comfenalco"],0);
              ...
              ?>
               ...
               <img src="../image/logounico.png" border="0" width="145" height="130">
				...
				<tr class="cajas">
                  <td colspan="40"><b>Total dias de ausentimos y Licencias no remuneradas en el perido de liquidacion:</b>&nbsp;<?echo $filas["diapermiso"];?>&nbsp;dias</td>
                </tr>
                <table border="0" align="center" width="710">
                <tr>
                   <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <tr>
                   ...
                   <tr class="cajas">
                   <td colspan="30"><div align="center"><b>Empleado:</b>&nbsp;----------------------------------------&nbsp;&nbsp;&nbsp;&nbsp;<b>Empresa:</b>&nbsp;----------------------------------------</div></td>
                    </tr>
                     <tr>
                   <td>&nbsp;</td>
                  </tr>
         ...
         <?
            ...
            while ($filas=mysql_fetch_array($resultado)):
             ...
             $DeduccionT=number_format($DeduccionV,2);
              ?>
               <table border="1" align="center" width="718"> <tr><td>
               ...
               $ResP=mysql_query($ConP)or die ("Error al buscar deducciones");
                ?>
                 <tr>
                  ...
                  <tr class="cajas">
                    </td><td colspan="50"><b>_____________________________________Novedades de las Prestaciones_______________________________________</b></td>
                    </tr>
                     <td>&nbsp;</td>
...
<table border="1" align="center"  width="610">
	           <tr class="cajas">
                ...
                <tr>
                 <td width="200"><b>Total Deducciones:</b>&nbsp;<td colspan="10"><div align="right"><b>$<?echo $DeduccionT;?></b></div></td>
                </tr>
                 <tr class="cajas">
                 ...
                 <tr>
                 <td width="30"><b>Total Pagar:</b>&nbsp;<td colspan="10"><div align="right"><b>$<?echo $total;?></b></div></td>
                </tr>
                <tr>
                   <td>&nbsp;</td>
                  </tr>
                     <tr class="cajas">
                    <td colspan="50"><b>Nota:</b>&nbsp;<?echo $filas["nota"];?></td>
                    </tr>
                  <tr>
                   <tr>
                   <td>&nbsp;</td>
