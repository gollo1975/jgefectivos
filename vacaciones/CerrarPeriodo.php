...
elseif(empty($Ano)):
   ...
   <?
	...
	if($regV !=0 ):
            ?>
		    <center><h4><u>Cerrar Periodo</u> </h4></center>
		    <form action="CerrarP.php" method="post" id="matPrima">
		     <table border="0" align="center" width="300">
		         <tr>
		          <td><b>Nro_Periodo:</b></td>
		         <td><input type="text" name="NroP" value="<? echo $filas["nrop"];?>"class="cajas" size="13" readonly></td>
		         <td><b>Desde:</b></td>
