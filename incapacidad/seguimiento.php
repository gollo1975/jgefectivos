...
if (!isset($cedula)):
  ?>
   <center><h4><u>Seguimiento</u></h4></center>
  ...
  <?
   ...
   $con="select concat(empleado.nomemple,' ' ,empleado.nomemple1,' ' ,empleado.apemple,' ' , empleado.apemple1) as nombre from empleado
       ...
       <tr><td><br></td></tr>
         ...
         while($filas=mysql_fetch_array($res1)):
           ?>
            <tr class="cajas">
               <th><?echo $a;?></th>
               <td><a href="detasegui.php?nro=<?echo $filas["nroinca"];?>&nombre=<?echo $filas_s["nombre"];?>"><?echo $filas["nroinca"];?></a></td>
