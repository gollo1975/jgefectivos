...
if (!isset($Cedula)){
     ?>
     <center><h4><u>EDITAR LICENCIAS</u></h4></center>
            ...
            <?
             $consu="select zona.zona, concat(nomemple, ' ', nomemple1, ' ', apemple, ' ', apemple1) as Empleado from empleado,zona where
              ...
              if ($registro!=0){
                   ...
                   <table border="0" align="center">
                       <tr class="cajas">
                          <td>Para ver las licencias del empleado, Presione Click Sobre el Documento.!</td>
                       </tr>
                   </table>
                  <table border="0" align="center">
                     <tr  class="cajas">
                   ...
                   while($filas_s=mysql_fetch_array($resulta)){
   	                ...
   	                <tr  class="cajas">
                            <th><?echo $i;?></th>
                            <td><a href="DetalleLicencia.php?Cedula=<?echo $Cedula;?>&codigo=<?echo $codigo;?>"><?echo $Cedula;?></a></td>
            ...
            <center><h4><u>Resultado de la Consulta</u></h4></center>
                  ...
                  <table border="0" align="center">
                   ...
                   while($filas_s=mysql_fetch_array($resulta)){
   	                ...
   	                <tr  class="cajas">
                            <th><?echo $i;?></th>
                            <td><a href="DetalleLicencia.php?Cedula=<?echo $filas_s["cedemple"];?>&codigo=<?echo $codigo;?>"><?echo $filas_s["cedemple"];?></a></td>
                            <td><?echo $filas_s["Empleado"];?></td>
                            <td><?echo $filas_s["zona"];?></td>
