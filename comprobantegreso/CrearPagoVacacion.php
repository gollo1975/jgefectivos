...
<body>
<center><h4><u>Comprobantes Egreso[Vacaciones]</u></h4></center>
<form action="DetalladoVacacion.php" method="post" name="vacacion" id="vacacion">
  ...
  <input type="hidden" name="codbanco" value="<?echo $codbanco;?>">
   <table border="0" align="center" width="580">
    ...
    <tr>
      ...
      <tr>
       <td><b>Nota:</b></td>
         <td colspan="5"><input type="text" value="PAGO DE VACACIONES " name="Nota" size="48" maxlength="35" class="cajas" id="Nota"></td>
       </tr>
       <tr>
         <td><b>Nro_Pago:</b></td>
