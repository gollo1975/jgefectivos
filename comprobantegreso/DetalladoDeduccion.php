...
?>
 <script language="javascript">
   alert("seleccione un nro de pago para el registro.!")
   history.back()
</script>
<?else:
	...
	$resC=mysql_query($Con)or die("Error al buscar Empresa");
        ...
        ?>
         <center><h4><u>Comprobante de Egreso[Deducciones]</u></h4></center>
		  ...
		  <input type="hidden" name="TipoComprobante" value="<?echo $TipoComprobante;?>">
		   ...
		   <table border="0" align="center" width="590">
		    ...
		    <tr class="cajas">
		      <th><b>Item</b></td><th><input type="checkbox" name="calculo" onClick="ActualizarSaldo()"></th><th><b>Cedula</b></th><th><b>Empleado</b></th><th><b>Vlr_Pagar</b></th><th><b>Zona</b></th>
		    </tr>
		    <?
                     $i=1;
                     $lista=$_POST["datoN"];
                    foreach($lista as $NroPago){
	                $ConV="select detalleprogramardeduccion.*,programardeduccion.vlrpagado,zona.nitzona from detalleprogramardeduccion,zona,programardeduccion
