...
<body>
<center><h4><u>Comprobantes Egreso[Deduccion X Facturas]</u></h4></center>
<form action="DetalladoDeduccionCompra.php" method="post" name="deduccion" id="deduccion">
  ...
  <input type="hidden" name="codbanco" value="<?echo $codbanco;?>">
   <table border="0" align="center" width="580">
    ...
    $Sql="select maestro.nomaestro from maestro where
                maestro.codmaestro = '$NitEmpresa'";
    $Sr=mysql_query($Sql) or die("error al buscar facturas de compras");
    $filaE=mysql_fetch_array($Sr);
    ?>
    <tr>
    ...
    <tr>
       <td><b>Empresa:</b></td>
       <td><input type="text" name="empresa" value="<?echo $filaE["nomaestro"];?>" size="47" class="cajas" readonly></td>
    </tr>
    <tr>
       <td><b>Municipio:</b></td>
      ...
      <tr>
       ...
       if($Cont != 0){
            ...
            <tr class="cajas">
	      <th><b>Item</b></th><th>&nbsp;</h><th><b>Id_Pago</b></th></th><th><b>Nro_Factura</b></th><th><b>Nit_Prove.</b></th></th><th><b>F_Proceso</b></th><th><b>Vlr_Pagado</b></th>
	    </tr><?
	    $i=1;
	    $con=0;
	    echo ("<input type=\"hidden\" id=\"Total\" name=\"Total\" value=\"" . mysql_num_rows($Res) . "\">");  ;
	    while($fila=mysql_fetch_array($Res)):
		  ...
		  <td><input type="text" value="<?echo $fila["id_p"];?>"  size="13" readonly class="cajas"></td>
                  <td><input type="text" value="<?echo $fila["nrofactura"];?>" name="NroFactura[<? echo $i;?>]"id="NroFactura[<? echo $i;?>]" size="13" readonly class="cajas"></td>
                   <td><input type="text" value="<?echo $fila["nitprove"];?>"  name="NitProve[<? echo $i;?>]"id="NitProve[<? echo $i;?>]" size="13" readonly class="cajas"></td>
