...
<form action="DetalladoNominaGrupal.php" method="post">
  <input type="hidden" name="empresa" value="<?echo $NitEmpresa;?>">
   ...
   <table border="0" align="center" width="565">
    ...
    <tr>
       <td><b>Municipio:</b></td>
       <td colspan="20"><select name="municipio" class="cajas">
	    ...
	    <?
	     ...
	     while ($filas_Z = mysql_fetch_array($resB)):
	           ...
	           <tr class="cajas">
                   <th><?echo $i;?></th>
	              <?
	              echo ("<td><input type=\"checkbox\" id=name=\"datos[" . $i . "]\" name=\"datos[" . $i . "]\" value=\"" . $filas_Z['codzona'] ."\" \"></td>");?>
